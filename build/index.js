...
app.post("/create-payment-intent", function (req, res) { var res; return __awaiter(void 0, void 0, void 0, function () {
        ...
        switch (_d.label) {
            ...
            case 1:
                ...
                params = {
                    ...
                    transfer_data: {
                        destination: "acct_1QpJKfD7DB0hX7zl",
                        amount: 1000,
                    },
...
body_parser_1.default.raw({ type: "application/json" }), function (req, res) {
    ...
    if (eventType === "payment_intent.payment_failed") {
        // console.log(`🔔  Webhook received: ${data.object} ${data.object}!`);
        // Cast the event into a PaymentIntent to make use of the types.
        var pi = data.object;
        console.log("\uD83D\uDD14  Webhook received: ".concat(pi.object, " ").concat(pi.status, "!"));
...
app.post("/payment-sheet", function (_, res) { return __awaiter(void 0, void 0, void 0, function () {
    var secret_key, stripe, account, feePercentage, applicationFeePercent, error_2, customers, customer, ephemeralKey, totalAmount, paymentIntent;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                secret_key = getKeys().secret_key;
                ...
                return [4 /*yield*/, stripe.accounts.retrieve("acct_1QpJKfD7DB0hX7zl")];
            case 1:
                account = _a.sent();
                feePercentage = 10;
                _a.label = 2;
            case 2:
                _a.trys.push([2, 4, , 5]);
                return [4 /*yield*/, stripe.applicationFees.list({ limit: 20 })];
            case 3:
                applicationFeePercent = _a.sent();
                return [3 /*break*/, 5];
            case 4:
                error_2 = _a.sent();
                console.error("Error fetching application fee percentage:", error_2);
                return [2 /*return*/, res
                        .status(500)
                        .send({ error: "Failed to fetch application fee percentage" })];
            case 5:
                if (applicationFeePercent.data.length > 0) {
                    applicationFeePercent.data.forEach(function (fee) {
                        console.log("Application fee percentage for account:", {
                            amount: fee.amount,
                            amount_refunded: fee.amount_refunded,
                            application: fee.application,
                            balance_transaction: fee.balance_transaction,
                            calculated_application_fee_amount: fee.calculated_application_fee_amount,
                            account: fee.account,
                        });
                    });
                }
            ...
            case 6:
                ...
                if (!customer) {
                    return [2 /*return*/, res.send({ error: "You have no customer created" })];
                }
            ...
            case 7:
                ...
                return [4 /*yield*/, stripe.paymentIntents.create({
                        ...
                        currency: "eur",
                        customer: customer.id,
                        // application_fee_amount: applicationFeeAmount, // Dynamic fee based on Stripe config
                        transfer_data: {
                            destination: "acct_1QpJKfD7DB0hX7zl",
                        },
...
app.post("/create-checkout-session", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var port, secret_key, stripe, effectivePort, customer, ephemeralKey, setupIntent;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
app.post("/customer-sheet", function (_, res) { return __awaiter(void 0, void 0, void 0, function () {
    var secret_key, stripe, customer, ephemeralKey, setupIntent;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                secret_key = getKeys().secret_key;
...
app.post("/fetch-payment-methods", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var secret_key, stripe, paymentMethods;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                secret_key = getKeys().secret_key;
                ...
                return [4 /*yield*/, stripe.customers.listPaymentMethods(req.body.customerId)];
            case 1:
                paymentMethods = _a.sent();
                res.json({
...
app.post("/attach-payment-method", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var secret_key, stripe, paymentMethod;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                secret_key = getKeys().secret_key;
                ...
                return [4 /*yield*/, stripe.paymentMethods.attach(req.body.paymentMethodId, { customer: req.body.customerId })];
            case 1:
...
app.post("/detach-payment-method", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var secret_key, stripe, paymentMethod;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, stripe.paymentMethods.detach(req.body.paymentMethodId)];
            case 1:
                paymentMethod = _a.sent();
                res.json({
                    paymentMethod: paymentMethod,
...
var savedPaymentOptions = new Map();
app.post("/set-payment-option", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
...
app.post("/get-payment-option", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var secret_key, stripe, customerPaymentOption, session;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                secret_key = getKeys().secret_key;
                ...
                customerPaymentOption = savedPaymentOptions.get(req.body.customerId);
                res.json({
